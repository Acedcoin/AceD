...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 ACED from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ACED in block rewards plus fees, but
        ...
        # Send 100 ACED with subtract fee from amount
        ...
        # Sendmany 100 ACED with subtract fee from amount
        ...
        total_txs = len(self.nodes[0].listtransactions("*",241269))
        ...
        assert_equal(total_txs, len(self.nodes[0].listtransactions("*",241269)))
