...
Note
---------------------
Always use absolute paths to configure and compile Polis Core and the dependencies,
...
with 4.8-built Polis Core is needed follow the steps under "Berkeley DB" above.
