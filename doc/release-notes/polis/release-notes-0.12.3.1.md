...
See detailed [change log](https://github.com/polispay/polis/compare/v0.12.2.3...polispay:v0.12.3.1) below.
...
- [`8a387ee09`](https://github.com/polispay/polis/commit/8a387ee09) Drop SPORK_13_OLD_SUPERBLOCK_FLAG and check superblock start hash (#1872)
...
- [`c0a1024127`](https://github.com/polispay/polis/commit/c0a1024127) Fix instantsend in testnet and regtest (#2016)
...
### Network:
- [`fda74b4a8`](https://github.com/polispay/polis/commit/fda74b4a8) Use correct protocol when serializing messages in reply to `getdata` (#2157)
...
- [`08033ffe4`](https://github.com/polispay/polis/commit/08033ffe4) Reject Dash-specific messages from obsolete peers (#1983)
...
- [`532b9fa3d`](https://github.com/polispay/polis/commit/532b9fa3d) Use OpenNetworkConnection instead of calling ConnectNode directly in Dash code (#1857)
...
### GUI:
- [`7ab5b4a28`](https://github.com/polispay/polis/commit/7ab5b4a28) Update/optimize images (#2147)
...
### Docs:
- [`a80ef0423`](https://github.com/polispay/polis/commit/a80ef0423) Update release notes (#2155)
- [`5e1149a65`](https://github.com/polispay/polis/commit/5e1149a65) Update release notes (#2142)
...
- [`4dbde218b`](https://github.com/polispay/polis/commit/4dbde218b) Fix p2pkh tests asserts (#2153)
- [`26c891f67`](https://github.com/polispay/polis/commit/26c891f67) Fix block value/payee validation in lite mode (#2148)
...
- [`ab96a6af6`](https://github.com/polispay/polis/commit/ab96a6af6) Update gitian keys, script and doc (#2082)
...
- [`4ea790377`](https://github.com/polispay/polis/commit/4ea790377) Dashify lib names (#2035)
...
- [`e37b6c7da`](https://github.com/polispay/polis/commit/e37b6c7da) Fix BIP147 deployment threshold parameter (#1955)
...
- [`c65613350`](https://github.com/polispay/polis/commit/c65613350) Switch masternode id in Dash data structures from CTxIn to COutPoint (#1933)
...
- [`a7fa07a30`](https://github.com/polispay/polis/commit/a7fa07a30) Drop BOOST_FOREACH and use references in loops (const ref where applicable, Dash code only) (#1899)
