...
This mechanism has been integrated into Bitcore-Node-AceD which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/acedpay/insight-api-aced#web-socket-api](https://github.com/acedpay/insight-api-aced#web-socket-api)
* API: [https://github.com/acedpay/insight-api-aced#instantsend-transactions](https://github.com/acedpay/insight-api-aced#instantsend-transactions)
...
By default, the AceD Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AceD Core daemon:
