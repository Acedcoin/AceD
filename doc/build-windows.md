...
Below are some notes on how to build AceD Core for Windows.
...
way. This will install to `c:\workspace\aced`, for example:

    make install DESTDIR=/mnt/c/workspace/aced
