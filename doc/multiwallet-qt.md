...
Only requiring some minor changes is aced.cpp.
...
Changes to aced.cpp
----------------------
aced.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
