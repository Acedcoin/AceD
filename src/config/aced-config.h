/* src/config/aced-config.h.  Generated from aced-config.h.in by configure.  */
/* src/config/aced-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ACED_CONFIG_H

#define ACED_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The AceD Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "AceD Core"
...
#define PACKAGE_BUGREPORT "https://github.com/acedpay/aced/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AceD Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AceD Core 1.11.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "acedcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://acedpay.org/"
