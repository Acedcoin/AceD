...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nDEPRECATED. Returns the current AceD address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account aced address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new AceD address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The aced address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The aced address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\"")
            + HelpExampleRpc("getaccount", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\"")
        );
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"address\"         (string) a aced address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The aced address to send to.\n"
            ...
            "                             The recipient will receive less amount of AceD than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The aced address\n"
...
UniValue listaddressbalances(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"address\": amount,       (string) The aced address and the amount in " + CURRENCY_UNIT + "\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The aced address to use for the private key.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The aced address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a aced address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The aced address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The aced address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less aceds than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\\\":0.01,\\\"PHUVxtZzm9rtQr9xfJHGY4aARZxaovGiYy\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\\\":0.01,\\\"PHUVxtZzm9rtQr9xfJHGY4aARZxaovGiYy\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\\\":0.01,\\\"PHUVxtZzm9rtQr9xfJHGY4aARZxaovGiYy\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const std::string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid AceD address: ")+name_);
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a AceD address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keys\"         (string, required) A json array of aced addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) aced address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"address\"         (string) A aced address associated with the keys.\n"
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The aced address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "    \"address\":\"address\",    (string) The aced address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The aced address involved in the transaction\n"
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() < 2 || request.params.size() > 3))
        throw std::runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending aceds\n"
            "\nArguments:\n"
    ...
    if (fForMixingOnly && !pwalletMain->IsLocked(true) && pwalletMain->IsLocked())
        throw JSONRPCError(RPC_WALLET_ALREADY_UNLOCKED, "Error: Wallet is already unlocked for staking only.");
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 1))
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending aced\n"
    ...
    StartShutdown();
    return "Wallet encrypted; AceD Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending aceds.\n"
...
UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            + (!fLiteMode ?
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized aced balance of the wallet in " + CURRENCY_UNIT + "\n" : "") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "2. maxconf          (numeric, optional, default=24126999) The maximum confirmations to filter\n"
            "3. \"addresses\"      (string) A json array of aced addresses to filter\n"
            "    [\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the aced address\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 24126999 \"[\\\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\\\",\\\"PHUVxtZzm9rtQr9xfJHGY4aARZxaovGiYy\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 24126999 \"[\\\"PK6NyLfYDqXyKXZz8EhJWjz3rReqT4VR4a\\\",\\\"PHUVxtZzm9rtQr9xfJHGY4aARZxaovGiYy\\\"]\"")
        );
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid AceD address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The aced address to receive the change\n"
                            ...
                            "                              Those recipients will receive less aced than you enter in their corresponding amount field.\n"
    ...
    if (request.params.size() > 1) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid aced address");
...
extern UniValue dumpprivkey_aced(const JSONRPCRequest& request); // in rpcdump.cpp
extern UniValue importprivkey(const JSONRPCRequest& request);
extern UniValue importaddress(const JSONRPCRequest& request);
extern UniValue importpubkey(const JSONRPCRequest& request);
extern UniValue dumpwallet_aced(const JSONRPCRequest& request);
...
{ //  category              name                        actor (function)           okSafeMode
    ...
    { "wallet",             "dumpprivkey",              &dumpprivkey_aced,        true,   {"address"}  },
    { "wallet",             "exportprivkey",            &dumpwallet_aced,         true,   {"filename"} },
