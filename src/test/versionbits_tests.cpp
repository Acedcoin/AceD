...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    for (int i = 0; i < 64; i++) {
        ...
        // DEFINED -> STARTED -> LOCKEDIN at the last minute -> ACTIVE
                           ...
                           .Mine(2999, TestTime(24130), 0x200).TestStarted().TestStateSinceHeight(2000) // 49 old blocks
                           .Mine(3000, TestTime(224126), 0x200).TestLockedIn().TestStateSinceHeight(3000) // 1 old block (so 900 out of the past 1000)
