...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(850, 572);
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ACED"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ACED"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ACED"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ACED"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 824, 69));
        ...
        labelBalance->setText(QStringLiteral("123.456 ACED"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        fallbackFeeWarningLabel->setToolTip(QApplication::translate("SendCoinsDialog", "Using the fallbackfee can result in sending a transaction that will take several hours or days (or never) to confirm. Consider choosing your fee manually or wait until your have validated the complete chain.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 politoshis and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 politoshis in fee,<br />while \"at least\" pays 1000 politoshis. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 politoshis and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 politoshis in fee,<br />while \"total at least\" pays 1000 politoshis. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for aced transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for aced transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkUseInstantSend->setText(QApplication::translate("SendCoinsDialog", "InstantSend", Q_NULLPTR));
