...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        showGovernanceTab = new QCheckBox(groupBox);
        showGovernanceTab->setObjectName(QStringLiteral("showGovernanceTab"));

        verticalLayout_2->addWidget(showGovernanceTab);
        ...
        verticalLayout_Wallet->addItem(verticalSpacer_2);
...
#ifndef QT_NO_TOOLTIP
        showGovernanceTab->setToolTip(QApplication::translate("OptionsDialog", "If you disable the spending of unconfirmed change, the change from a transaction<br/>cannot be used until that transaction has at least one confirmation.<br/>This also affects how your balance is computed.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        showGovernanceTab->setText(QApplication::translate("OptionsDialog", "Show Governance Tab", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the AceD Core client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AceD network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AceD network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/projects/p/aced/", Q_NULLPTR));
