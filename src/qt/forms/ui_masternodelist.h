...
public:
    ...
    void setupUi(QWidget *MasternodeList)
    {
        ...
        QRButton = new QPushButton(tabMyMasternodes);
        QRButton->setObjectName(QStringLiteral("QRButton"));

        horizontalLayout_5->addWidget(QRButton);
    ...
    void retranslateUi(QWidget *MasternodeList)
    {
        ...
        updateNote->setText(QApplication::translate("MasternodeList", "Note: Status of your masternodes in local wallet can potentially be slightly incorrect.<br />Always wait for wallet to sync additional data and then double check from another node<br />if your masternode should be running but you still do not see \"ENABLED\" in \"Status\" field.", Q_NULLPTR));
        ...
        ___qtablewidgetitem5->setText(QApplication::translate("MasternodeList", "Last Seen", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidgetMyMasternodes->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("MasternodeList", "Payee", Q_NULLPTR));
        ...
        QRButton->setToolTip(QApplication::translate("MasternodeList", "Show additional Masternode information", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        QRButton->setText(QApplication::translate("MasternodeList", "Show &Info...", Q_NULLPTR));
        ...
        ___qtablewidgetitem11->setText(QApplication::translate("MasternodeList", "Last Seen", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem12 = tableWidgetMasternodes->horizontalHeaderItem(5);
        ___qtablewidgetitem12->setText(QApplication::translate("MasternodeList", "Payee", Q_NULLPTR));
