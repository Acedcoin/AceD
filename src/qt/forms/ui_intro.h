...
public:
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        sizeWarningLabel->setText(QApplication::translate("Intro", "%1 will download and store a copy of the AceD block chain. At least %2GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", Q_NULLPTR));
