    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("aced-light"), QVariant("light"));
    ui->theme->addItem(QString("aced-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("aced-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("aced-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("aced-traditional"), QVariant("trad"));
