...
{
    const char* pszTimestamp = "AceD, Value in Anonymity";
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsStartBlock = 9999999919; // actual historical value
        consensus.nBudgetPaymentsCycleBlocks = 16616; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 166384784; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
	...
	consensus.nLastPoWBlock = 98000;
        ...
        assert(genesis.hashMerkleRoot == uint256S("0x1cde7f8fec77dea780f272eae6f67d830603ce8f64ab1c6f2487d72e9d4a3e27"));
        ...
        // aced BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // aced BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        ...
        strSporkAddress = "Acn9hkWdgmhNMxSRDuqS5ZBrSP7CCQ2mUk";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x0000041cabdf1c1929ae937a6041b6f215c0eb85753ce077003f521d3f9fdf6c"))

        };
        chainTxData = ChainTxData{
            1526883743, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetSpacing = 40; // aced: 2.5 minutes
        ...
        vAlertPubKey = ParseHex("12345d8a699cb43d3938d7b24faaff7cda448ca4ea267723ba614784de661949bf632d6304316b244646dea079735b9a6fc4af804efb4752075b9fe2245e14e412");
        nDefaultPort = 21430;
        //nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1526249131, 285983, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256S("0x1cde7f8fec77dea780f272eae6f67d830603ce8f64ab1c6f2487d72e9d4a3e27"));
        assert(consensus.hashGenesisBlock == uint256S("0x0000074870afcbfa0ef4c0a8153c639d79db00f137ded0f5d067d79788a38966"));
...
public:
    CRegTestParams() {
      ...
      genesis = CreateGenesisBlock(1513831322, 887612, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8b4b710853705984ef576c0c6844ec6e25f2a058520664c36b6d13b47db8f9cb"));
        assert(genesis.hashMerkleRoot == uint256S("0x1cde7f8fec77dea780f272eae6f67d830603ce8f64ab1c6f2487d72e9d4a3e27"));
