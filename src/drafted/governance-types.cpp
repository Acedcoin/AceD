...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "acedNetwork") type = acedNetwork;
    if(strType == "acedNetworkVariable") type = acedNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == acedNetwork) s = "acedNetwork";
    if(type == acedNetworkVariable) s = "acedNetworkVariable";
