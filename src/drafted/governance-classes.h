 ...
 *
 *   // network
 *   CacedNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.aced.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CacedNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: acedNetwork
// //   -- signature requirements : Key1(User)
// class CacedNetworkVariable : public CGovernanceObject
// {
// private:
